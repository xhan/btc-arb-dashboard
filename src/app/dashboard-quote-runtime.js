(function (root, factory) {
  ...
  function createDashboardQuoteRuntime(options = {}) {
    ...
    const quoteFetchController = options.quoteFetchControllerUtils.createQuoteFetchController({
      ...
      checkPriceForAlerts: options.checkPriceForAlerts,
      ...
      scheduleArbPanelUpdate: options.scheduleArbPanelUpdate,
      scheduleDataTerminalUpdate: options.scheduleDataTerminalUpdate,
