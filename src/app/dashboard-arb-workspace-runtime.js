(function (root, factory) {
  ...
  function buildArbAlertOptions(options = {}) {
    ...
    return {
      ...
      fixedPathActionsControllerUtils: modules.getDashboardFixedPathActionsController(),
      ...
      arbPathNotesUtils: modules.getArbPathNotesUtils(),
      ...
      pathAlertEditorUtils: modules.getPathAlertEditorUtils(),
      ...
      fixedPathActionRefs: refs.fixedPathActions,
