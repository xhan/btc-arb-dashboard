...
module.exports = {
  ...
  "alerts": [
    {
      "id": "path-alert-1773395309298-wsvgtj",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    {
      "id": "path-alert-1773395448007-8tdyqg",
      "name": "",
      "enabled": true,
      "thresholdBp": 3,
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:wbtc-eth-arb"
      }
    },
    {
      "id": "path-alert-1773395462112-azn84r",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:wbtc-btc-no-arb"
      }
    },
    {
      "id": "path-alert-1773395470616-nlf3sx",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "immediate",
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:lbtc-btc"
      }
    },
    {
      "id": "path-alert-1773395486976-4kofo7",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:tbtc-wbtc"
      }
    },
    {
      "id": "path-alert-1773395497305-sbvftd",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:tbtc-btc"
      }
    },
    {
      "id": "path-alert-1773395519056-v4tize",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    },
    {
      ...
      "target": {
        "type": "rule",
        "ruleKind": "fixed",
        "ruleId": "fixed:usde-usdt"
      }
    },
    {
      "id": "path-alert-1773395529000-susdeusdt",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    {
      "id": "path-alert-1773395534395-7dqza3",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    {
      "id": "path-alert-1773395547322-hjr9fq",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    {
      "id": "path-alert-1773395562730-l0mb3v",
      "name": "",
      "enabled": true,
      "thresholdBp": 1,
      "triggerMode": "delayed",
    ...
    {
      "id": "rule-alert-special-wbtc-bybit",
      "name": "WBTC <-> BYBIT",
      "enabled": true,
      "thresholdBp": 0,
      "triggerMode": "delayed",
