...
(async () => {
  try {
    ...
    assert.ok(response.body.includes('src="/vendor/morphdom.js"'));
    assert.ok(response.body.includes('src="src/ui/interaction-safe-renderer.js"'));
    assert.ok(response.body.indexOf('src="/vendor/morphdom.js"') < response.body.indexOf('src="src/alerts/alert-runtime-controller.js"'));
    assert.ok(response.body.indexOf('src="src/ui/interaction-safe-renderer.js"') < response.body.indexOf('src="src/arb/arb-panel-controller.js"'));
    ...
    assert.ok(response.body.includes('src="src/app/dashboard-app-workspace-runtime.js"'));
    ...
    assert.ok(
      response.body.indexOf('src="src/app/dashboard-aux-panels-runtime.js"') < response.body.indexOf('src="src/app/dashboard-module-registry.js"')
    );
    assert.ok(
      response.body.indexOf('src="src/app/dashboard-app-workspace-runtime.js"') < response.body.indexOf('src="src/app/dashboard-app.js"')
    );
    assert.ok(
    ...
    const auxPanelsRuntimeResponse = await request('/src/app/dashboard-aux-panels-runtime.js');
    assert.strictEqual(auxPanelsRuntimeResponse.statusCode, 200);
    const appWorkspaceRuntimeResponse = await request('/src/app/dashboard-app-workspace-runtime.js');
    assert.strictEqual(appWorkspaceRuntimeResponse.statusCode, 200);
    ...
    const interactionSafeRendererResponse = await request('/src/ui/interaction-safe-renderer.js');
    assert.strictEqual(interactionSafeRendererResponse.statusCode, 200);
    const morphdomResponse = await request('/vendor/morphdom.js');
    assert.strictEqual(morphdomResponse.statusCode, 200);
    assert.ok(morphdomResponse.body.includes('morphdom'));
    ...
    assert.ok(coreRuntimeResponse.body.includes('const dashboardInputInteractionRuntime = interactionSafeRenderer.createInteractionRuntime({'));
    ...
    assert.ok(boardRuntimeResponse.body.includes('interactionSafeRenderer.createInteractionSafeViewRuntime({'));
    ...
    assert.ok(boardRuntimeResponse.body.includes('releaseTarget: documentImpl'));
    assert.ok(boardRuntimeResponse.body.includes('interactionSafeRenderer.morphElementChildren(target, nextDashboard)'));
    ...
    assert.ok(appWorkspaceRuntimeResponse.body.includes('modules.getDashboardAuxPanelsRuntime().createDashboardAuxPanelsRuntime({'));
    assert.ok(auxPanelsRuntimeResponse.body.includes('modules.getDashboardQuoteSpreadRuntime().createDashboardQuoteSpreadRuntime({'));
    ...
    assert.ok(appJsResponse.body.includes('onQuoteMainFetchSuccess: handleQuoteMainFetchSuccess,'));
    assert.ok(runtimeRefUtilsResponse.body.includes("arbWorkspaceRuntimeRef.callOr(false, 'handleQuoteMarketStateChanged', quote, state, context)"));
    assert.ok(runtimeRefUtilsResponse.body.includes("arbWorkspaceRuntimeRef.callOr(false, 'handleQuoteMainFetchSuccess', quote, context)"));
    ...
    assert.ok(moduleRegistryResponse.body.includes('getInteractionSafeRenderer: ['));
    assert.ok(moduleRegistryResponse.body.includes('InteractionSafeRenderer is not loaded'));
    assert.ok(!appJsResponse.body.includes('pathAlertPanelHtmlRenderer'));
    assert.ok(alertRuntimeControllerResponse.body.includes('interactionSafeRenderer.createInteractionSafeHtmlRenderer({'));
    ...
    assert.ok(alertRuntimeControllerResponse.body.includes('releaseTarget: documentImpl'));
    ...
    assert.ok(alertRuntimeControllerResponse.body.includes('alertSettingsHtmlRenderer.update(alertLogUiUtils.buildAlertSettingsPanelHtml({'));
    assert.ok(alertRuntimeControllerResponse.body.includes('mutedAlertStateHtmlRenderer.update(panelHtml);'));
    assert.ok(!alertRuntimeControllerResponse.body.includes('bindAlertContentInteractionRuntime('));
    ...
    assert.ok(appJsResponse.body.includes('arbWorkspaceRuntimeRef,'));
    assert.ok(appJsResponse.body.includes('dataTerminalRuntimeRef,'));
    assert.ok(appJsResponse.body.includes('dashboardViewRenderRuntimeRef,'));
    ...
    assert.ok(!appJsResponse.body.includes('let arbWorkspaceRuntime = null;'));
    assert.ok(!appJsResponse.body.includes('let arbDetailController = null;'));
    ...
    assert.ok(arbPanelControllerResponse.body.includes('interactionSafeRenderer.createInteractionSafeHtmlRenderer({'));
    assert.ok(arbPanelControllerResponse.body.includes('releaseTarget: documentImpl'));
    assert.ok(!arbPanelControllerResponse.body.includes('function handleContentFocusOut(event)'));
    assert.ok(interactionSafeRendererResponse.body.includes('function createInteractionRuntime(options = {})'));
    assert.ok(interactionSafeRendererResponse.body.includes('function createCommitRuntime(options = {})'));
    assert.ok(interactionSafeRendererResponse.body.includes('function createInteractionSafeHtmlRenderer(options = {})'));
    assert.ok(interactionSafeRendererResponse.body.includes('function createInteractionSafeViewRuntime(options = {})'));
    assert.ok(interactionSafeRendererResponse.body.includes('function morphElementChildren(target, nextContent, options = {})'));
    assert.ok(interactionSafeRendererResponse.body.includes("node.getAttribute('data-render-key')"));
    assert.ok(!domRenderUtilsResponse.body.includes('function createStableHtmlRenderer(options = {})'));
    assert.ok(!domRenderUtilsResponse.body.includes('function createRenderInteractionDeferralRuntime(options = {})'));
    assert.ok(dataTerminalControllerResponse.body.includes('interactionSafeRenderer.createInteractionSafeHtmlRenderer({'));
    assert.ok(dataTerminalControllerResponse.body.includes('trackFocus: false'));
    assert.ok(dataTerminalControllerResponse.body.includes('releaseTarget: deps.documentImpl'));
    ...
    assert.ok(appWorkspaceRuntimeResponse.body.includes('const createdArbWorkspaceRuntime = modules.getDashboardArbWorkspaceRuntime().createDashboardArbWorkspaceRuntime({'));
    assert.ok(appWorkspaceRuntimeResponse.body.includes('const arbWorkspaceRuntime = setRuntimeRef(deps.arbWorkspaceRuntimeRef, createdArbWorkspaceRuntime);'));
    ...
    assert.ok(arbPanelControllerResponse.body.includes('arbPanelHtmlRenderer.update(nextArbPanelHtml);'));
    ...
    assert.ok(dataTerminalControllerResponse.body.includes('contentRenderer.update('));
    ...
    assert.ok(auxPanelsRuntimeResponse.body.includes('modules.getDashboardDataTerminalRuntime().createDashboardDataTerminalRuntime({'));
    ...
    assert.ok(appJsResponse.body.includes('onQuoteMarketStateChangedSideEffect: scheduleDataTerminalUpdate,'));
    assert.ok(runtimeRefUtilsResponse.body.includes("scheduleDataTerminalUpdate: () => dataTerminalRuntimeRef.callOr(false, 'scheduleDataTerminalUpdate')"));
