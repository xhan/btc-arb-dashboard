...
(async () => {
  try {
    ...
    assert.ok(appJsResponse.body.includes('getRealLegCount: (alertItem, alertEvaluation) => ('));
    assert.ok(appJsResponse.body.includes('getPathAlertUtils().countPathAlertRealLegs(alertItem, alertEvaluation)'));
    ...
    assert.ok(appJsResponse.body.includes('hasActiveTarget: () => getDashboardRuntimeUtils().hasActivePathAlertEvaluationTarget(pathAlertConfig)'));
    ...
    assert.ok(appJsResponse.body.includes('const mutedPathStorageRuntime = getMutedPathStorageUtils().createMutedPathStorageRuntime({'));
    assert.ok(appJsResponse.body.includes('mutedPathStorageRuntime.loadTargets()'));
    assert.ok(appJsResponse.body.includes('mutedPathStorageRuntime.loadLegs()'));
    assert.ok(appJsResponse.body.includes('mutedPathStorageRuntime.persistTargets(mutedPathRuntime.getTargets())'));
    assert.ok(appJsResponse.body.includes('mutedPathStorageRuntime.persistLegs(mutedPathRuntime.getLegs())'));
    ...
    assert.ok(appJsResponse.body.includes('const evaluationAlerts = getDashboardRuntimeUtils().getActivePathAlertEvaluationAlerts(pathAlertConfig);'));
