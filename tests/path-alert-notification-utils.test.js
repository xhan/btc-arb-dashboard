...
} = require('../src/path-alerts/path-alert-notification-utils');
...
assert.strictEqual(
  Object.prototype.hasOwnProperty.call(require('../src/path-alerts/path-alert-notification-utils'), 'buildLegacyQuoteAlertRemotePayload'),
  false
);
